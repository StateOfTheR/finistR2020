...
author: "Antoine Bichat, Pierre Gloaguen"
date: "26/08/2020"
output: html_document
---

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, message = FALSE, wartning = FALSE)
```
...
```{r packages_fable, message = FALSE}
library(tidyverse)
library(tsibble)
library(fable)
```
...
fitted_mable %>%
  ...
  geom_path() +
  facet_wrap(~ Purpose + .model, scale = "free_y")
```
