...
The main motivation behind KeOps is the need to compute fast and scalable Gaussian convolutions (**RBF kernel products**). For **very large values** of $M$and $N$, given :
...
Performing such calculations is useful because kernels are widely used in Statistics and Learning:
