...
La séléction tidy est un outil complémentaire qui facilite le travaille sur les colonnes d'un jeu de données. En général, il faut différencier les variables selon qu'elles sont dans le dataframe ou dans l'environnment. 
