...
Pour améliorer un peu plus les performances, on peut utiliser la version Julia de la fonction dérivée. On peut transformer toutes les variables R en variables Julia:
